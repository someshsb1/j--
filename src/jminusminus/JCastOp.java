...
class Conversions {
    ...
    public Conversions() {
        ...
        put(Type.DOUBLE, Type.INT, new D2I()); // double to int conversions
        put(Type.LONG, Type.INT, new L2I()); // long to int conversions
        put(Type.INT, Type.DOUBLE, new I2D()); // int to double conversions
        put(Type.LONG, Type.DOUBLE, new L2D()); // long to double conversions
        put(Type.DOUBLE, Type.LONG, new D2L()); // double to long conversions
        ...
        put(Type.LONG, Type.BOXED_LONG, new Boxing(Type.LONG, Type.BOXED_LONG)); //boxing long type
