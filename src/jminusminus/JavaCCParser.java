...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    SwitchStatementGroup statement1 = null;
...
line = token.beginLine;
        ...
        while (true) {
          ...
          statement1 = switchBlockStatementGroup();
stmtGroup.add(statement1);
        }
        jj_consume_token(RCURLY);
...
{if ("" != null) return statements;}
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {JStatement statement = null;
...
{if ("" != null) return statements;}
  ...
  final private SwitchStatementGroup switchBlockStatementGroup() throws ParseException {JExpression switchlabel = null;
    JStatement statement = null;
...
{if ("" != null) return new SwitchStatementGroup(switchLabel, blockStatement);}
    throw new Error("Missing return statement in function");
}
...
line = expr.line();
            if (expr instanceof JAssignment
             ...
             || expr instanceof JPostIncrementOp //support added for ++
             || expr instanceof JPreDecrementOp //support added for --
...
{if ("" != null) return lhs;}
  ...
  final private JExpression conditionalExpression() throws ParseException {int line = 0;
    JExpression lhs = null, rhs = null, trueExpr = null, falseExpr = null;
    try {
...
lhs = new JConditionalExpression(line, lhs, trueExpr, falseExpr);
        break;
        }
      default:
        jj_la1[57] = jj_gen;
